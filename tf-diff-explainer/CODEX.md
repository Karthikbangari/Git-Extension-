...
- 2026-05-31: README refresh in progress: root README now documents TFE 5-step flow, current test counts, and `verify:extensions`; GFE README now documents BP-018..BP-022 polish features and current GitHub DOM fallbacks.
