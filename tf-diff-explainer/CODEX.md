...
- 2026-05-31: Added repo-level Playwright verifier `npm run verify:extensions` with screenshot output in `verify-shots/`. Latest verifier run: 12 pass, 0 fail, 1 expected warning for GitHub `.png` image preview not rendering a blob-code sidebar target. Latest re-checks: lint ✅, format ✅, TFE 191/191 ✅, GFE 81/81 ✅, TFE build ✅, GFE build ✅.
